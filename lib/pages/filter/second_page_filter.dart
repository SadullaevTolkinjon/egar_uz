...
class SecondPageFilter extends StatefulWidget {
  var data;
  SecondPageFilter({Key? key, this.data}) : super(key: key);

  @override
  _SecondPageFilterState createState() => _SecondPageFilterState();
}

class _SecondPageFilterState extends State<SecondPageFilter> {
  List tapped = [];
  @override
